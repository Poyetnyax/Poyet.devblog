        ...
        <section id="resume" className="resume__container">
            ...
            <div className="resume__cards">
                <div className='education__cards'>
                    ...
                    <Card period="March 2023 - June 2026" field="Bachelor of Science in Computer Science" place="WSEI University" description="Specialized in Software Engineering and Mobile Technology" />
                </div>
